...
const generateDescription = async (req, res) => {
    try {
        ...
        const prompt = `Create an appealing description for the following product: "${briefDescription}". 
        Make it sound enticing but not too overwhelming for potential customers.
